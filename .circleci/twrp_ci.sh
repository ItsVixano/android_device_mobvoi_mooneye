...
DEVICE_TREE="https://github.com/ItsVixano/android_device_mobvoi_mooneye"
DEVICE_BRANCH="omni-8.0"

# Check https://github.com/minimal-manifest-twrp/platform_manifest_twrp_omni branches for that
TWRP_VERSION="twrp-8.0"
...
DATE=$(date +"%Y%m%d")
	...
	if [ -f "$IMG" ]; then
		TWRP_IMGAGE="twrp-3.4.0-1_"$CODENAME"_"$DATE".img"
		mkdir sender
